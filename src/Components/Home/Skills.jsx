          ...
          Array.from({ length: 3 }).map((ele, ind) =>
            <Card sx={{ background: ind % 2 === 0 ? "rgba(211, 211, 211,.5)" : "rgb(6, 6, 34)" }} className={styles.skill_card}>
              ...
              <div className={ind % 2 === 0 ? styles.div2 : styles.div}>
                <Typography sx={{ borderColor: color[Math.ceil(Math.random() * color.length)], margin: 1.3, color: "white", fontWeight: 600 }} className={styles.skills} >HTML</Typography>
                <Typography sx={{ borderColor: color[Math.ceil(Math.random() * color.length)], margin: 1.3, color: "white", fontWeight: 600 }} className={styles.skills} >CSS</Typography>
                <Typography sx={{ borderColor: color[Math.ceil(Math.random() * color.length)], margin: 1.3, color: "white", fontWeight: 600 }} className={styles.skills} >JavaScript</Typography>
                <Typography sx={{ borderColor: color[Math.ceil(Math.random() * color.length)], margin: 1.3, color: "white", fontWeight: 600 }} className={styles.skills} >Responsive Design</Typography>
                <Typography sx={{ borderColor: color[Math.ceil(Math.random() * color.length)], margin: 1.3, color: "white", fontWeight: 600 }} className={styles.skills} >CSS Flexbox</Typography>
                <Typography sx={{ borderColor: color[Math.ceil(Math.random() * color.length)], margin: 1.3, color: "white", fontWeight: 600 }} className={styles.skills} >Frameworks</Typography>
                <Typography sx={{ borderColor: color[Math.ceil(Math.random() * color.length)], margin: 1.3, color: "white", fontWeight: 600 }} className={styles.skills} >Librearies</Typography>
              </div>
            </Card>
          )
